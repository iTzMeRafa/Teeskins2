...
export default class AdminMarkingUpload extends React.Component {
          ...
          <div className="row">
            ...
            <div className="col-md-9">
              <GridCore
                  ...
                  assets={data.viewData.marking}
                  numPerRow={3}
                  updateDownloads={false}
                  updateLikes={false}
                  sortType={data.viewData.sortType}
                  page={data.viewData.page}
                  idURL={this.urlService.mergeBaseWithURL(URLS.MarkingUploads)}
...
if (document.getElementById('app')) {
  ReactDOM.render(<AdminMarkingUpload />, document.getElementById('app'));
}
