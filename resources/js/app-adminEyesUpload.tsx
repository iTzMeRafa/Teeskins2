...
export default class AdminEyesUpload extends React.Component {
          ...
          <div className="row">
            ...
            <div className="col-md-9">
              <GridCore
                  ...
                  idURL={this.urlService.mergeBaseWithURL(URLS.EyesUploads)}
...
if (document.getElementById('app')) {
  ReactDOM.render(<AdminEyesUpload />, document.getElementById('app'));
}
