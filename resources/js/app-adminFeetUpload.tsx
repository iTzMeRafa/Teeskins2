...
export default class AdminFeetUpload extends React.Component {
          ...
          <div className="row">
            ...
            <div className="col-md-9">
              <GridCore
                  ...
                  idURL={this.urlService.mergeBaseWithURL(URLS.FeetUploads)}
...
if (document.getElementById('app')) {
  ReactDOM.render(<AdminFeetUpload />, document.getElementById('app'));
}
